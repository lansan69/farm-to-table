...
export declare class DefaultPresence implements Presence {
    ...
    private readonly _unsubscribePresenceEvents;
    private readonly _offChannelUpdate;
    private readonly _offChannelDetach;
    /**
     ...
     */
    private _realtimeMemberToPresenceMember;
     ...
     */
    private _emitPresenceStateChange;
}
