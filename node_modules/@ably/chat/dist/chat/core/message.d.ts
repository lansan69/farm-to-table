...
export declare class DefaultMessage implements Message {
    ...
    readonly timestamp: Date;
    readonly reactions: MessageReactionSummary;
    constructor({ serial, clientId, text, metadata, headers, userClaim, action, version, timestamp, reactions, }: DefaultMessageParams);
    with(event: Message | ChatMessageEvent | MessageReactionSummaryEvent): Message;
    /**
 ...
 */
export declare const emptyMessageReactions: () => MessageReactionSummary;
